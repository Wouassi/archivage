...
class ExerciceResource extends Resource {
    ...
    public static function form(Form $form): Form {
        return $form->schema([Forms\Components\Section::make('📅 Exercice budgétaire')
    ...
    public static function table(Table $table): Table {
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('date_debut')->label('Début')->date('d/m/Y')->icon('heroicon-o-arrow-right')->iconColor('info'),
            Tables\Columns\TextColumn::make('date_fin')->label('Fin')->date('d/m/Y')->icon('heroicon-o-arrow-left')->iconColor('warning'),
    ...
    public static function getPages(): array {
        return ['index' => Pages\ListExercices::route('/'), 'create' => Pages\CreateExercice::route('/create'), 'edit' => Pages\EditExercice::route('/{record}/edit')];
    }
}
